        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <form action="newsType" method="POST"> 
                                <h6>Add News Type</h6>
                            ...
                            <h1>Update</h1>
                            <form action="editNewsType" method="POST">                                
                                <div class="form-group mt-3">
                                    <h6>Update Type</h6>
                                    <input type="text" name="type" class="form-control" value="${typeUpdate.getTypeName()}" placeholder="Update Type name " required>                      
                                </div>
                                <div class="form-group mt-3">
                                    <h6>Update Description </h6>
                                    <textarea class="form-control"  name="description" rows="5"  placeholder="Please fill in the description of this course (~50 words)" required>${typeUpdate.getTypeDescription()}</textarea>                       
                                </div>
                                <div  style="color:red"> ${msgU} </div>
                                <input type="hidden" name="id" value="${typeUpdate.getTypeID()}" />
                                        ...
                                        <table id="datatablesSimple">
                                            ...
                                            <tbody>                                           
                                                <c:forEach var="i" items="${type}">
                                                    <tr> 
                                                        <td>${i.getTypeName()}</td>
                                                        <td>${i.getTypeDescription()}</td>
                                                        <td>
                                                            <a href="editNewsType?id=${i.getTypeID()}">Edit</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
